...
const ContactModal = ({ isOpen, onClose }) => {
  ...
  const handleSubmit = (e) => {
    ...
    // Construimos el mensaje formateado para WhatsApp para EXIT
      ...
      <div className="bg-slate-900 border border-cyan-500/30 rounded-2xl w-full max-w-md relative shadow-[0_0_50px_rgba(34,211,238,0.1)] overflow-hidden">
        ...
        <div className="p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-xs font-bold text-cyan-400 uppercase tracking-wider mb-2">Tu Rol Actual / Experiencia</label>
              <input 
                type="text" 
                name="currentRole"
                required
                ...
                onChange={handleChange}
                className="w-full bg-slate-950 border border-white/10 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition-all placeholder-gray-600"
                placeholder="Ej. Director de Marketing, Abogado..."
              />
            </div>

            <div>
              <label className="block text-xs font-bold text-cyan-400 uppercase tracking-wider mb-2">Correo Personal</label>
              <input 
                type="email" 
                name="email"
                required
    ...
    <div className="min-h-screen bg-slate-950 text-slate-200 font-sans selection:bg-cyan-500/30 selection:text-cyan-200 overflow-x-hidden">
              ...
              <div className="flex flex-col md:flex-row items-center gap-8 bg-gradient-to-r from-slate-900 to-slate-800 p-8 rounded-2xl border border-cyan-500/20 shadow-2xl">
                  ...
                  <div className="flex-grow">
                      ...
                      <p className="text-gray-400">
                          No te doy peces, te enseño a construir la piscifactoría. Al terminar, tendrás un ecosistema digital en vivo, una estrategia AIO funcionando y una
                          <span className="text-cyan-400 font-bold"> "Gema Clon"</span> entrenada con mi cerebro estratégico para guiarte cuando la mentoría termine.
                      </p>
                  </div>
              </div>
          </div>
      ...
      <section className="py-24 container mx-auto px-6 relative">
          ...
          <div className="space-y-12 max-w-4xl mx-auto">
              <PhaseCard 
                number={1}
                title="Mes 1: Definición & Validación"
                duration="30 Días"
                description="Encontramos tu nicho rentable. Analizamos los mercados digitales y usamos IA Generativa para validar qué negocio se adapta a tus capacidades e intereses reales."
                items={[
                    "Auditoría de tus habilidades y pasiones",
                    "Análisis de viabilidad de ideas con IA",
                    "Estudio del potencial embudo (impresiones, leads, ventas)",
                    "Definición final del modelo de negocio"
                ]}
              />
              <PhaseCard 
                number={2}
                title="Mes 2: Construcción del Ecosistema"
                duration="30 Días"
                description="Manos a la obra. Te enseño paso a paso a construir la infraestructura digital necesaria para que tu negocio exista y opere."
                items={[
                    "Construcción de Web y activos digitales con IA",
                    "Configuración de herramientas (CRM, Analytics)",
                    "Creación de la 'Forma de Trabajar Virtuosa'",
                    "Integración de automatizaciones básicas"
                ]}
              />
              <PhaseCard 
                number={3}
                title="Mes 3: Dominación AIO & SEO"
                duration="30 Días"
                description="Tráfico y visibilidad. Implementamos la estrategia para que tu negocio sea encontrado por humanos (Google) y por máquinas (ChatGPT/Gemini)."
                items={[
                    "Estrategia de contenidos SEO tradicional",
                    "Optimización para Motores de Respuesta (AIO)",
                    "Entrega de la 'Gema Clon' estratégica",
                    "Plan de vuelo para los siguientes 12 meses"
                ]}
              />
          </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
              ...
              <div className="bg-slate-900/50 p-8 rounded-2xl border border-cyan-500/20 relative overflow-hidden">
                  ...
                  <h3 className="text-xl font-bold text-white mb-6 flex items-center gap-2">
                      <ShieldCheck className="text-cyan-400" /> Mi Promesa de Valor
                  </h3>
                  <ul className="space-y-4">
                      {[
                          "Feedback Sincero: Si tu idea no es viable, te lo diré antes de que gastes un euro.",
                          "Análisis de Datos Reales: Proyecciones objetivas de tráfico y ventas, sin cuentos.",
                          "Transferencia de Conocimiento: Te enseño a usar la IA para construir, no lo hago 'caja negra'.",
                          "Plan Estratégico a Medida: Diseñado para tus fortalezas, no una plantilla genérica.",
                          "Tu 'Gema Clon' personal: Te llevas mi cerebro digitalizado para consultas futuras."
                      ].map((item, i) => (
              ...
              <div className="bg-slate-900/50 p-8 rounded-2xl border border-red-500/20 relative overflow-hidden">
                  ...
                  <h3 className="text-xl font-bold text-white mb-6 flex items-center gap-2">
                      <Lock className="text-red-400" /> Tus Deberes (No Negociables)
                  </h3>
                  <ul className="space-y-4">
                      {[
                          "Compromiso de 3 meses: No abandonar cuando la curva de aprendizaje suba.",
                          "Confianza Ciega: Creer en el nicho y el plan que definamos juntos.",
                          "Inversión en Herramientas: Tú pagas tus dominios, hosting, APIs y software.",
                          "Disciplina Diaria: Aplicar la metodología de trabajo sin excusas.",
                          "Cero Presencialidad: Todo ocurre en digital, optimizando el tiempo.",
                          "Foco: Asistir a las reuniones y ejecutar las tareas entre sesiones."
                      ].map((item, i) => (
                          <li key={i} className="flex items-start gap-3 text-gray-300 text-sm">
              ...
              <div className="inline-block p-1 rounded-3xl bg-gradient-to-br from-cyan-500 via-blue-600 to-purple-600 mb-12">
                  <div className="bg-slate-950 rounded-[22px] px-12 py-16">
                      ...
                      <p className="text-gray-400 mb-8 max-w-md mx-auto">
                          Programa intensivo de 3 meses.<br/>
                          Tu pasaporte a la independencia profesional.
                      </p>
                      ...
                      >
                          Validar mi Candidatura <ArrowRight size={20} />
                      </button>
                      
                      <p className="mt-6 text-xs text-gray-600">
                          *Plazas muy limitadas debido a la intensidad del 1-on-1.
                      </p>
                  </div>
              </div>
          </div>
      ...
      <footer className="py-8 text-center text-gray-600 text-sm border-t border-white/5">
          <p>© 2026 ALEJO MORENO.ai | Exit Mentorship Program</p>
      </footer>
