...
const ContactModal = ({ isOpen, onClose }) => {
  ...
  const handleSubmit = (e) => {
    ...
    // Construimos el mensaje formateado para WhatsApp para AGENCIAS
      ...
      <div className="bg-slate-900 border border-cyan-500/30 rounded-2xl w-full max-w-md relative shadow-[0_0_50px_rgba(34,211,238,0.1)] overflow-hidden">
        ...
        <div className="p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-xs font-bold text-cyan-400 uppercase tracking-wider mb-2">Nombre de la Agencia</label>
              <input 
                type="text" 
                name="agencyName"
                required
                ...
                onChange={handleChange}
                className="w-full bg-slate-950 border border-white/10 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition-all placeholder-gray-600"
                placeholder="Ej. Creativos 360"
              />
            </div>

            <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-bold text-cyan-400 uppercase tracking-wider mb-2">Tu Rol</label>
                  <input 
                    type="text" 
                    name="role"
                    required
                ...
                <div>
                  <label className="block text-xs font-bold text-cyan-400 uppercase tracking-wider mb-2">Tamaño Equipo</label>
                  <input 
                    type="text" 
                    name="teamSize"
                    required
            ...
            >
              Solicitar Intervención <Send size={18} className="group-hover:translate-x-1 transition-transform" />
            </button>
          </form>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-slate-950 text-slate-200 font-sans selection:bg-cyan-500/30 selection:text-cyan-200 overflow-x-hidden">
              ...
              <div className="flex flex-col md:flex-row items-center gap-8 bg-gradient-to-r from-slate-900 to-slate-800 p-8 rounded-2xl border border-cyan-500/20 shadow-2xl">
                  ...
                  <div className="flex-grow">
                      ...
                      <p className="text-gray-400">
                          Vendes horas de personas. Para facturar más, necesitas más gente, y tu margen se mantiene plano. 
                          Mi intervención rompe esa ecuación: implementamos <span className="text-cyan-400 font-bold">Activos de IA y Automatización</span> que ejecutan el trabajo repetitivo, permitiendo que tu agencia escale beneficios, no costes.
                      </p>
                  </div>
              </div>
          </div>
      ...
      <section className="py-24 container mx-auto px-6 relative">
          ...
          <div className="space-y-12 max-w-4xl mx-auto">
              <PhaseCard 
                number={1}
                title="Fase 1: Diagnóstico 'As-Is'"
                duration="Mes 1 - 2"
                description="Radiografía brutal de la realidad. Analizamos la rentabilidad real de cada servicio y la eficiencia de los procesos actuales."
                items={[
                    "Auditoría de offering, precios y rentabilidad real",
                    "Mapa de procesos: Liderazgo, equipos y tecnología",
                    "Identificación de cuellos de botella y costes ocultos",
                    "Análisis de la pila tecnológica actual"
                ]}
              />
              <PhaseCard 
                number={2}
                title="Fase 2: Plan Estratégico & Cultura"
                duration="Mes 3 - 5"
                description="Diseño del futuro modelo operativo. Definimos cómo será la agencia impulsada por IA y alineamos a todos los stakeholders."
                items={[
                    "Construcción del Plan Estratégico a 1 año",
                    "Diseño de nuevas herramientas propietarias",
                    "Socialización del cambio: Accionistas, Dirección y Equipo",
                    "Gestión del cambio cultural hacia la IA"
                ]}
              />
              <PhaseCard 
                number={3}
                title="Fase 3: Construcción & Despliegue"
                duration="Mes 6 - 8"
                description="La fábrica de software. Construyo e implemento las herramientas de IA y automatización que sustituirán los procesos manuales."
                items={[
                    "Desarrollo del 100% de herramientas de IA Generativa",
                    "Creación de nuevos Manuales y Workflows automatizados",
                    "Redefinición de Job Descriptions para el nuevo modelo",
                    "Gestión de proyectos con metodología OKR"
                ]}
              />
              <PhaseCard 
                number={4}
                title="Fase 4: Gestión & Transferencia"
                duration="Mes 9 - 12"
                description="Acompañamiento directivo para asegurar la adopción. No me voy hasta que el equipo vuele solo con las nuevas herramientas."
                items={[
                    "Feedback de negocio y consultoría directiva",
                    "Lectura conjunta de dashboards de rentabilidad",
                    "Formación intensiva en gestión de las herramientas",
                    "Entrega de la 'Gema Clon' estratégica"
                ]}
              />
          </div>
      </section>
      ...
      <section className="py-24 bg-slate-900 border-y border-white/5">
          <div className="container mx-auto px-6">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                  {[
                      { icon: Cpu, title: "Herramientas IA Propias", desc: "Desarrollo del 100% del software de IA necesario para la operación." },
                      { icon: FileText, title: "Manuales Operativos", desc: "Documentación y workflows actualizados para el trabajo con IA." },
                      { icon: Users, title: "Nuevos Roles (JD)", desc: "Redefinición de puestos de trabajo adaptados a la nueva realidad." },
                      { icon: Workflow, title: "Automatización Total", desc: "Flows que conectan CRM, Project Management y entregables." },
                      { icon: Bot, title: "Gemas Corporativas", desc: "Asistentes de IA entrenados con el know-how de la agencia." },
                      { icon: BarChart3, title: "Dashboard de Medición", desc: "Visualización en tiempo real de los KPIs definidos en el Plan Estratégico." },
                  ].map((item, i) => (
          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
              ...
              <div className="bg-slate-900/50 p-8 rounded-2xl border border-cyan-500/20 relative overflow-hidden">
                  ...
                  <ul className="space-y-4">
                      {[
                          "Producción ILIMITADA de herramientas, manuales y workflows necesarios.",
                          "Inmersión total: Conoceré tu negocio mejor que tu equipo.",
                          "Obsesión por los OKRs: Ejecución orientada a resultados medibles.",
                          "Autonomía Final: Al mes 12, la agencia opera sola con el nuevo sistema.",
                          "Tu Director de IA Virtual: Entrega de una Gema Clon estratégica para consultas futuras."
                      ].map((item, i) => (
              ...
              <div className="bg-slate-900/50 p-8 rounded-2xl border border-red-500/20 relative overflow-hidden">
                  ...
                  <h3 className="text-xl font-bold text-white mb-6 flex items-center gap-2">
                      <Lock className="text-red-400" /> Compromisos de la Agencia
                  </h3>
                  <ul className="space-y-4">
                      {[
                          "Estabilidad: Sin cambios radicales en marca/precios durante la intervención.",
                          "Blindaje Estratégico: El plan aprobado NO se cambia a mitad de camino.",
                          "Respeto a la Obra: No pedir cambios en herramientas o manuales ya definidos.",
                          "Acceso Total: Google Workspace, CRM, Finanzas, Ads, CMS (Llaves del reino).",
                          "Mentalidad Remote-First: Cero reuniones presenciales.",
                          "Transparencia de Datos: Entrega de insumos reales para medición."
                      ].map((item, i) => (
                          <li key={i} className="flex items-start gap-3 text-gray-300 text-sm">
              ...
              <div className="inline-block p-1 rounded-3xl bg-gradient-to-br from-cyan-500 via-blue-600 to-purple-600 mb-12">
                  <div className="bg-slate-950 rounded-[22px] px-12 py-16">
                      ...
                      <p className="text-gray-400 mb-8 max-w-md mx-auto">
                          Contrato anual de transformación.<br/>
                          Reingeniería profunda de procesos y tecnología.
                      </p>
      ...
      <footer className="py-8 text-center text-gray-600 text-sm border-t border-white/5">
          <p>© 2026 ALEJO MORENO.ai | Agency Transformation Program</p>
      </footer>
